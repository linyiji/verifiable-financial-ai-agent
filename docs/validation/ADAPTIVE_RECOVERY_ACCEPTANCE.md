...
Offline contract tests cover policy ceilings, identity/capability constraints, denied unsafe cases and adaptive execution. The repository preparation uses no live provider or data calls.

Scope is the bounded recovery foundation, not full Evaluation/POT, unrestricted autonomous route optimization, or a guarantee that all new provider failures recover.

[Runtime architecture](../architecture/ADAPTIVE_RUNTIME.md) · [Historical foundation receipt](../integration/PHASE6_RECOVERY_FOUNDATION.md).
