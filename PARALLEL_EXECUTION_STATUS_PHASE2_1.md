...
| P Scheme Route Repair | McClintock | `ws/scheme-route-repair` | `/Users/mac/Verifiable_Financial_Agent_System_worktrees/scheme-route-repair` | MERGED | 14 focused; 128 branch full; real Scheme `gpt-5.6-sol` PASS; Ruff/secret PASS | none |
