    ...
    return [
        LLMMessage(
            ...
            content=(
                ...
                "using the approved formula; never hard-code one fixture-specific result. For "
                "decimal financial contracts, import decimal.Decimal, parse every numeric input "
                "as Decimal, and keep all arithmetic in Decimal; never convert through float, "
                "round, or quantize the result. Source "
